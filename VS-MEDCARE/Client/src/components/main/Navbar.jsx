        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <HashLink smooth="true" className="nav-link" to="/#about">
                  About
                </HashLink>
              </li>
              <li className="nav-item">
                <Link smooth="true" className="nav-link" to="/doctor">
                  Doctor's
                </Link>
              </li>
              <li className="nav-item">
                <HashLink smooth="true" className="nav-link" to="/#medcamp">
                  Medical Camps
                </HashLink>
              </li>
              <li className="nav-item">
                <HashLink smooth="true" className="nav-link" to="/#team">
                  Team
                </HashLink>
              </li>
              <li className="nav-item">
                <HashLink smooth="true" className="nav-link" to="/#contact">
                  Contact
                </HashLink>
              </li>
              {log ? (
